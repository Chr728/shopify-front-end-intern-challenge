					...
					<div class="carousel-item active">
						<div class="d-block w-100px" style="height: 900px; background-color: #051622; color: #DEB992; text-align: center; font-size: 5px;">
							...
							<form action="nasa.jsp" method="POST">
								...
								<input type="submit" class="btn btn-outline-success" value="Unlike" style="margin-top: 1%; background-color: #1BA098; font-size: 24px; padding: 15px 62px;">
								<% } else { %>
								<div class="d-grid gap-2 d-md-flex justify-content-md-center">
									<input type="submit" class="btn btn-outline-success" value="Like" style="margin-top: 1%; background-color: #1BA098; font-size: 24px; padding: 15px 62px;">
								</div>
								<%}%>
							</form>
						</div>
